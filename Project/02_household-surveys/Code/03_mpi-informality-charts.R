...
ggsave('Plots/03_mpi-dpto-bar-chart.png',
       plot = p_mpi_dpto, 
       device = 'png', width = 15, height = 11, units = 'in', dpi = 300)


ggsave('Plots/03_mpi-ii-dpto-scatter.png', 
       plot = p_scatter_mpi_ii, 
       device = 'png', width = 15, height = 11, units = 'in', dpi = 300)


ggsave('Plots/03_panel-mpi-ii.png', 
       plot = panel_mpi_ii, 
       device = 'png', width = 15, height = 11, units = 'in', dpi = 300)


ggsave('Plots/03_mpi-ii-rates-by-cluster.png', 
       plot = p_rates_clusters, 
       device = 'png', width = 15, height = 11, units = 'in', dpi = 300)


ggsave('Plots/03_panel-mpi-ii-select-clusters.png', 
