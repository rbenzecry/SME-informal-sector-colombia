...
emicron <- read.csv("Project/Data/emicron_index.csv") %>% 
...
source("Project/Code/02_household-surveys/00_house-and-services-mpi-2022.R")

# Labour dimension
source("Project/Code/02_household-surveys/00_labour-mpi-2022.R")

# Education and health dimensions
source("Project/Code/02_household-surveys/00_education-health-mpi-2022.R")

# Add basic migrant variables
source("Project/Code/02_household-surveys/00_migration-emicron-2022.R")
...
write_dta(emicron, "Project/Data/02_emicron-informality-mpi.dta")
